  ...
  if($('#chartContainer').length){
    var chart = new CanvasJS.Chart("chartContainer",
    {
      ...
      {        
        ...
        //lineThickness: 3,        
        dataPoints: [
        { x: new Date(2012, 0, 1), y: 5 , lineColor: "#ffbe00" },
        { x: new Date(2012, 1, 1), y: 9, lineColor: "#ffbe00" },
        { x: new Date(2012, 2, 1), y: 17, lineColor: "#ffbe00" },
        { x: new Date(2012, 3, 1), y: 22, lineColor: "#ffbe00"  },
        { x: new Date(2012, 4, 1), y: 32 , lineColor: "#ffbe00" },
        { x: new Date(2012, 5, 1), y: 40, lineColor: "#ffbe00"  },
        { x: new Date(2012, 6, 1), y: 25 , lineColor: "#ffbe00" },
        { x: new Date(2012, 7, 1), y: 23 , lineColor: "#ffbe00" },
        { x: new Date(2012, 8, 1), y: 50 , lineColor: "#ffbe00" , indexLabel: "Highest",markerColor: "#fff", markerType: "circle", markerBorderColor : "#ffbe00", markerBorderThickness: 4,},
        { x: new Date(2012, 9, 1), y: 20 , lineColor: "#ffbe00" },
