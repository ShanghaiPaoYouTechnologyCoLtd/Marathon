...
(function() {
	...
	MobileSelect.prototype = {
		...
		renderWheels : function(wheelsData, cancelBtnText, ensureBtnText) {
			...
			_this.mobileSelect.innerHTML = '<div class="grayLayer"></div>' +
				'<div class="content">' +
				'<div class="btnBar">' +
				'<div class="fixWidth">' +
		...
		generateArrData : function(targetArr) {
			...
			for (var i = 0; i < targetArr.length; i++) {
				var tempObj = {};
				if (typeof targetArr[i] == "string") {
					tempObj[keyMap_id] = "";
					tempObj[keyMap_value] = targetArr[i];
				} else {
		...
		checkRange : function(index, posIndexArr) {
			...
			for (var i = 0; i <= index; i++) {
				if (i == 0)
					resultNode = _this.cascadeJsonData[posIndexArr[0]];else {
