						...
						<div class="col-md-9 kf_shop_wrap">
							...
							<div class="bigBlock">
								<div class="separateBlock separate1  tran3s"
									data-url="passport/marathonPassport.jsp?rid=4">
									<img src="extra-images/icon/single.png" /> <br /> <a
										class="tran3s theme-button" href="javascript:;">个人办理</a>
								</div>
								<div class="separateBlock separate2  tran3s"
									data-url="passport/marathonPassport.jsp">
									<img src="extra-images/icon/cooperation.png" /><br /> <a
										class="tran3s theme-button" href="javascript:;">合作赛事办理</a>
								</div>
								<!-- 								<div class="separateBlock separate3  tran3s"
									data-url="passport/passportQuery.jsp">
									<img src="extra-images/icon/query.png" /> <br /> <a
										class="tran3s theme-button" href="javascript:;">查询</a>
								</div> -->
								<div class="separateBlock separate3  tran3s"
									data-url="">
									<img src="extra-images/icon/team.png" /> <br /> <a
										class="tran3s theme-button" href="javascript:;">团体办理</a>
								</div>
								<div class="separateBlock separate4  tran3s"
									data-url="passport/passportUnreceive.jsp">
									<img src="extra-images/icon/receive.png" /> <br /> <a
										class="tran3s theme-button" href="javascript:;">补领护照</a>
								</div>
							</div>
						</div>
					</div>
