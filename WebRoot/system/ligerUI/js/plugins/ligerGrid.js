...
(function ($)
{
    ...
    //自定义类型checkbox 郭磊20161207
    $.ligerDefaults.Grid.formatters['checkbox'] = function (value, column)
    {
        return "<input type='checkbox' "+(value==0?"":"checked")+" onclick='javascript:return false;' style='margin-top:-1px'/>"
    }
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        showFilter: function (WHTL)
        {
            if (WHTL == null)
                WHTL = { w: 420, h: 208, t: 100, l: 380 };
            var g = this, p = this.options;
            if (g.winfilter)
            {
                g.winfilter.show();
            ...
            return g.winfilter = $.ligerDialog.open({
                width: WHTL.w, height: WHTL.h,
                target: filtercontainer, isResize: true, top: WHTL.t,left:WHTL.l,
                buttons: [
