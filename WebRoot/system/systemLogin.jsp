...
<link href="system/css/bootstrap.undo.min.css" rel="stylesheet"
	type="text/css" />
...
<link href="system/css/style-responsive.css" rel="stylesheet"
	type="text/css" />
<link href="system/css/default.css" rel="stylesheet" type="text/css"
	id="style_color" />
<link href="system/css/uniform.default.css" rel="stylesheet"
	type="text/css" />
...
<body class="login">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i> <input class="m-wrap placeholder-no-fix"
							type="text" placeholder="账户" name="username" id="username" />
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i> <input class="m-wrap placeholder-no-fix"
							type="password" placeholder="密码" name="passport" id="password" />
					</div>
				</div>
			</div>
	...
	<div class="copyright">2017 &copy; 上海跑友科技有限公司<br/></div>
