...
var App = function () {
    ...
    //框架高度控制 
    //郭磊 2016.11.24
    var frameHeightControl = function () {
        var maxHeight = document.documentElement.clientHeight;
        maxHeight -= $(".navbar").height();
        maxHeight -= $(".footer").height();
        maxHeight -= 7;  //所有边框
        $(".page-content").css({ "min-height": maxHeight });
        $(".portlet").css({ "min-height": maxHeight-20 });
    }
    ...
    var footHtml = function () {
        $(".footer-inner").html(gv_copyright);
    }
    //* END:CORE HANDLERS *//
